...
public class Data {
    ...
    Map<String, List<Request>> musicianRequestsMap;
    ...
    public Data() {
        ...
        this.musicianRequestsMap = new HashMap<>();
        ...
        Event event1 = new Event("https://image.freepik.com/free-vector/rock-n-roll-poster-with-words-long-live-rock-n-roll-design-t-shirt_1284-49229.jpg", "Long Live Rock'n Roll", "Central Café", "14/01/22, 21:30");
        List<Event> eventList1 = new ArrayList<>();
        eventList1.add(event1);
        musicianEventsMap.put("musician@mail.com", eventList1);
        Request request1 = new Request(R.drawable.check_circle, "Cafe Central accepted your request to perform for Long Live Rock'n Roll.");
        Request request2 = new Request(R.drawable.priority_high, "Kara Woolley wants to join your band King Red.");
        List<Request> requestList1 = new ArrayList<>();
        requestList1.add(request1);
        requestList1.add(request2);
        musicianRequestsMap.put("musician@mail.com", requestList1);
    ...
    public List<Request> getMusicianRequests(String email) {
        return musicianRequestsMap.get(email);
    }
